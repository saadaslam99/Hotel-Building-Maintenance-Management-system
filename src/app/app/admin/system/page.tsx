                ...
                <TabsContent value="logs">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                A comprehensive audit trail of all system actions, including user management, unit assignments, and issue tracking.
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                                            ...
                                            logs.slice().reverse().map((log) => (
                                                <TableRow key={log.id}>
                                                    ...
                                                    <TableCell className="max-w-[400px]">
                                                        <span className="text-sm line-clamp-2" title={log.details}>
                                                            {log.details || '-'}
                                                        </span>
                                                    </TableCell>
